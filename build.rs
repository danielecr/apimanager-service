...
fn main() {
    ...
    let mut phfmime = phf_codegen::Map::new();
    writeln!(file, "// This file is generated by build.rs").unwrap();
    writeln!(file, "// Do not edit it manually").unwrap();
    ...
    for f in files.iter() {
        ...
        let mime_type = mime_guess::from_path(f)
            .first_or(mime::APPLICATION_OCTET_STREAM)
            .to_string();
        let mime_type_wrapped = format!("\"{}\"", mime_type);
        // write the map of file to mime type
        phfmime.entry(
            format!("{}", name),
            mime_type_wrapped,
        );
    ...
    write!(
        &mut file,
        "pub static STATIC_FILEMAP_MIME: phf::Map<&'static str, &'static str> = {}",
        phfmime.build()
    )
    .unwrap();
    writeln!(file, ";\n").unwrap();
